...
//             <h4 className="font-semibold mb-3 sm:mb-4 text-sm md:text-base text-gray-300">Products</h4>
//             <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
//               <li>
//                 <Link href="/pages/products/autouw" className="text-gray-300 hover:text-blue-300 transition-colors">
//                   AutoUW
//                 </Link>
//               </li>
//               <li>
...
//               </li>
//               <li>
//                 <Link href="/pages/products/clarity360" className="text-gray-300 hover:text-blue-300 transition-colors">
//                   Clarity360
//                 </Link>
//               </li>
//             </ul>
...
//             <h4 className="font-semibold mb-3 sm:mb-4 text-sm md:text-base text-gray-300 text-left">Services</h4>
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-x-20">
...
//             <h4 className="font-semibold mb-3 sm:mb-4 text-sm md:text-base text-gray-300">Resources</h4>
//             <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
//               <li>
//                 <Link
...
//               </li>
//               <li>
//                 <Link href="/blog" className="text-gray-300 hover:text-blue-300 transition-colors">
//                   Blog
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/pages/security/" className="text-gray-300 hover:text-blue-300 transition-colors">
//                   Security
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/pages/disclaimer" className="text-gray-300 hover:text-blue-300 transition-colors">
//                   Disclaimer
//                 </Link>
//               </li>
//               {/* Bug Bounty */}
...
//             <Link href="/pages/privacy-policy/" className="hover:text-blue-300 transition-colors">
//               Privacy Policy
//             </Link>
//             <Link href="/pages/terms-and-conditions" className="hover:text-blue-300 transition-colors">
//               Terms & Conditions
//             </Link>
//             <Link href="/pages/contact-us" className="text-gray-300 hover:text-blue-300 transition-colors">
//               Contact Us
//             </Link>
//             <button onClick={handleOpenPreferences} className="hover:text-blue-300 transition-colors">
//               Cookie Preferences
//             </button>
//           </div>
...
//           <div className="text-center sm:text-right pt-2 sm:pt-0">© 2025 Clik.ai. All rights reserved</div>
//         </div>
//       </div>
...
import { Input } from "@/components/ui/input"
import { Button } from "@/components/ui/button"
import { Linkedin, Facebook, Twitter, Youtube, ChevronDown, ChevronUp } from "lucide-react"
import { useState } from "react"
import { CookiePreferencesPopup } from "./cookie-preference-popup"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="text-left">
            ...
            >
              <h4 className="font-semibold text-sm md:text-base text-gray-300">Products</h4>
            ...
            <ul
              className={`space-y-2 sm:space-y-3 text-xs sm:text-sm overflow-hidden transition-all duration-300 ease-in-out ${productsOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0 sm:max-h-96 sm:opacity-100"}`}
            >
              <li>
                <Link href="/pages/products/autouw" className="text-gray-300 hover:text-blue-300 transition-colors">
                  AutoUW
          ...
          <div className="col-span-1 sm:col-span-2 flex flex-col">
            ...
            >
              <h4 className="font-semibold text-sm md:text-base text-gray-300">Services</h4>
              <div className="sm:hidden">
                {servicesOpen ? (
                  <ChevronUp className="h-4 w-4 text-gray-300" />
                ) : (
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-x-20 overflow-hidden transition-all duration-300 ease-in-out ${servicesOpen ? "max-h-[800px] opacity-100" : "max-h-0 opacity-0 sm:max-h-[800px] sm:opacity-100"}`}
            >
              {/* Left Services Column */}
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-left">
                <li>
          ...
          <div className="flex flex-col text-left sm:ml-0 md:ml-20">
            ...
            >
              <h4 className="font-semibold text-sm md:text-base text-gray-300">Resources</h4>
              <div className="sm:hidden">
                {resourcesOpen ? (
                  <ChevronUp className="h-4 w-4 text-gray-300" />
                ) : (
            ...
            <ul
              className={`space-y-2 sm:space-y-3 text-xs sm:text-sm overflow-hidden transition-all duration-300 ease-in-out ${resourcesOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0 sm:max-h-96 sm:opacity-100"}`}
            >
              <li>
                <Link
                  href="https://clik-ai.gitbook.io/"
