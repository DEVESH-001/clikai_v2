...
//   const handleCTA = (planName: string, ctaType: string) => {
//     if (ctaType === "Instant Access") {
//       setFormTitle("Get Instant Access to Self-Service Plan")
//       setFormDescription("Fill out the form below to get started with our Self-Service plan")
//     } else {
//       setFormTitle(`Book a Demo for ${planName} Plan`)
//       setFormDescription("Schedule a personalized demo with our team to learn more")
//     }
...
//   const handleCTA = (planName: string, ctaType: string) => {
//     setFormTitle(ctaType === "Instant Access" ? "Get Instant Access" : "Book a Demo")
//     setShowPricingForm(true)
//   }
...
//         </div>
//         {showPricingForm && (
//           <PricingFormModal isOpen={showPricingForm} onClose={() => setShowPricingForm(false)} formTitle={formTitle} />
//         )}
//       </div>
//     </section>
//   )
