...
const products = [
  {
    ...
    image: "/images/Products_Section_Images/AutoUW/Hero_Image.png",
    link: "/pages/products/autouw",
    theme: "blue",
    height: "500",
    width: "500",
  },
  {
    ...
    image: "/images/Products_Section_Images/InvestAssist/Hero_Image.png",
    link: "/pages/products/InvestAssist",
    theme: "emerald",
    height: "500",
    width: "500",
  },
  {
    ...
    image: "/images/Products_Section_Images/SmartExtract/Hero_Image.png",
    link: "/pages/products/SmartExtract",
    theme: "violet",
    height: "500",
    width: "500",
  },
  {
    ...
    image: "/images/Products_Section_Images/Clarity360/Hero_Image.png",
    link: "/pages/products/clarity360",
    theme: "indigo",
    height: "500",
    width: "500",
  },
...
export function ProductCards({}: ProductCardsProps) {
  return (
    <section
      className={`relative py-6 md:py-8 lg:py-12 overflow-hidden bg-gradient-to-b from-indigo-50 via-purple-50 to-blue-50 ${GeistSans.className}`}
    >
