      ...
      <GradientBackground>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center rounded-full border border-blue-200 bg-white px-3 py-1 text-sm leading-6 text-blue-700 mb-8">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              style={{ y }}
              className="relative lg:h-[660px]"
            >
              <div className="relative w-full h-full">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-02-06%20at%206.42.52%E2%80%AFPM-LXzvxunalt5XwY2rMbK716fyD4692q.png"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Extract data from all major commercial real estate document types
            </p>
          </motion.div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600">
                  Powerful extraction with minimal code. Developer-friendly API.
                </p>
              </div>
              <CodePreview>
            ...
            <div className="space-y-4">
              <Card className="bg-gradient-to-br from-white to-gray-50 border-blue-100">
                <CardHeader className="pb-2">
                  <CardTitle className="text-xl">Integration Methods</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-blue-100 max-w-3xl mx-auto mb-8">
              Join the industry leaders processing over 100,000 documents yearly
            </p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
